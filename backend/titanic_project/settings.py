...
ROOT_URLCONF = 'titanic_project.urls'  # <-- IMPORTANTE: Ajusta según tu proyecto
...
WSGI_APPLICATION = 'titanic_project.wsgi.application'  # <-- IMPORTANTE: Ajusta según tu proyecto
